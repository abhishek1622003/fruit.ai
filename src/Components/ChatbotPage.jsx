...
<div class="flex items-center gap-4">
    <img class="w-11 h-11 rounded-full" src="https://pngimg.com/d/mark_zuckerberg_PNG35.png" alt=""/>
    <div class="font-medium dark:text-white">
        <div>Mark Bot</div>
        <div class="text-sm text-gray-500 dark:text-black">Joined in August 2014</div>
    </div>
</div>
